...
public class ProdutoTest {
    ...
    public void testValidarLimiteZeroProibidoValorProduto(){
      ...
      // Inserir um produto com valor 0.00 e validar que a mensagem de erro foi apresentada e o status code é 422
    ...
    public void testValidarLimiteSeteMilProibidoValorProduto(){

        // Inserir um produto com valor 7000.01 e validar que a mensagem de erro foi apresentada e o status code é 422
        given()
                .contentType(ContentType.JSON)
                .header("token", this.token)
